  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        data-size={size}
        className={cn(
          'group/alert-dialog-content bg-popover text-popover-foreground ring-foreground/10 data-open:animate-in',
          'data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0',
          'data-closed:zoom-out-95 fixed top-1/2 left-1/2 z-50 grid w-full -translate-x-1/2 -translate-y-1/2 gap-4',
          'rounded-xl p-4 ring-1 duration-100 outline-none data-[size=default]:max-w-xs data-[size=sm]:max-w-xs data-[size=default]:sm:max-w-sm',
          className,
        )}
        {...props}
      />
  ...
  return (
    <div
      ...
      className={cn(
        ...
        'has-data-[slot=alert-dialog-media]:gap-x-4 sm:group-data-[size=default]/alert-dialog-content:place-items-start',
...
function AlertDialogFooter({ className, ...props }: ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'bg-muted/50 -mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-xl border-t p-4 group-data-[size=sm]/alert-dialog-content:grid',
...
function AlertDialogAction({
  ...
  return (
    <Button variant={variant} size={size} asChild className="active:not-aria-[haspopup]:-translate-y-1">
      <AlertDialogPrimitive.Action
        data-slot="alert-dialog-action"
        className={cn('active:translate-y-0', className)}
        {...props}
      />
    </Button>
  );
