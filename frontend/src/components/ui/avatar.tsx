  ...
  return (
    <AvatarPrimitive.Root
      ...
      className={cn(
        ...
        'after:inset-0 after:rounded-full after:border after:mix-blend-darken data-[size=lg]:size-10 data-[size=sm]:size-6',
        'data-[size=xl]:size-12 dark:after:mix-blend-lighten',
        className,
      )}
      {...props}
    />
